...
class Xero_demo extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('xero_demo', array('authorized' => $authorized));
	...
	public function get_contacts() { 
		if ($this->authorize()) {
			...
			if (!isset($contactsData->Contacts)) { die('no contacts'); }
...
/* End of file xero_demo.php */
/* Location: ./application/controllers/xero_demo.php */